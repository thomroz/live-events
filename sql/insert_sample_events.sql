...
VALUES (1, 'tennis', '2025-09-01 10:00:00', 60, 15, 1500.00);
...
INSERT INTO `live_events.events` (id, event_name, start_time_utc, event_duration, extra_time, spend)
VALUES (2, 'hockey', '2025-09-01 13:30:00', 90, 15, 2200.00);

INSERT INTO `live_events.events` (id, event_name, start_time_utc, event_duration, extra_time, spend)
VALUES (3, 'football', '2025-09-01 14:45:00', 90, 15, 3000.00);
...
INSERT INTO `live_events.events` (id, event_name, start_time_utc, event_duration, extra_time, spend)
VALUES (4, 'soccer', '2025-09-01 17:00:00', 90, 15, 2500.00);
...
INSERT INTO `live_events.events` (id, event_name, start_time_utc, event_duration, extra_time, spend)
VALUES (5, 'tennisNight', '2025-09-01 20:00:00', 75, 15, 1800.00);

-- Test Case 5: Event ending exactly at start of analysis hour
-- Event ends at 22:00, analysis at 21:45 for hour 22:00-23:00
INSERT INTO `live_events.events` (id, event_name, start_time_utc, event_duration, extra_time, spend)
VALUES (6, 'hockeyEvening', '2025-09-01 20:30:00', 75, 15, 2100.00);

-- Test Case 6: Multiple overlapping events in same hour
-- All three events overlap during 08:00-09:00 hour
INSERT INTO `live_events.events` (id, event_name, start_time_utc, event_duration, extra_time, spend)
VALUES (7, 'footballMorning', '2025-09-01 07:30:00', 90, 15, 2800.00);

INSERT INTO `live_events.events` (id, event_name, start_time_utc, event_duration, extra_time, spend)
VALUES (8, 'soccerMorning', '2025-09-01 08:15:00', 75, 15, 2300.00);

INSERT INTO `live_events.events` (id, event_name, start_time_utc, event_duration, extra_time, spend)
VALUES (9, 'tennisMorning', '2025-09-01 08:45:00', 60, 15, 1600.00);
...
1. 11:45 analysis → 12:00-13:00 hour: NO events (isolated case)
2. 13:45 analysis → 14:00-15:00 hour: hockey + football overlap
3. 17:45 analysis → 18:00-19:00 hour: soccer active
4. 19:45 analysis → 20:00-21:00 hour: tennisNight starts exactly at 20:00
5. 21:45 analysis → 22:00-23:00 hour: hockeyEvening ends exactly at 22:00
6. 07:45 analysis → 08:00-09:00 hour: multiple overlapping events
